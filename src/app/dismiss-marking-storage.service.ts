...
//   providedIn: 'root'
// })
// export class DissmisMarkingStorageService {
...
//     }
//
// //     localStorage.setItem(`penda-dismissed-markings-${this.highlightedMarkingIndex}`, JSON.stringify(this.processedText?.text ?? this.EMPTY_STRING).toString());
// // localStorage.getItem('penda-dismissed-markings', true);
//   constructor() {
